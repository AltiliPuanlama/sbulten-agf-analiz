...
st.set_page_config(page_title="Trakus Excel Yarış Analizi", layout="wide")
st.title("🐎 Trakus Verileri Analiz Paneli")

# Kullanıcıdan dosya yüklemesi istenir
uploaded_file = st.file_uploader("Trakus Excel dosyasını yükleyin (.xlsx)", type=["xlsx", "xls"])
